...
classical_data = load_data("data/classical-exact.txt")
...
compare_plots(classical_data, maj3_data, dx=0.001, dy=0.001, show=True)
...
# Load QSP-3 data
qsp3_data = load_data("data/qsp-3-data.txt")
rdg_plot(qsp3_data, dx=0.001, dy=0.001, show=True)

# Compare QSP-3 with MAJ-3
compare_plots(maj3_data, qsp3_data, dx=0.001, dy=0.001, filename="img/advantage-success.png", show=True)
compare_plots(1-qsp3_data, 1-maj3_data, dx=0.001, dy=0.001, scalelabel="Log error ratio", filename="img/advantage-error.png", show=True)
